...
class GBMWizardSelfTest:

    def __init__(self, parent):
        parent.title = "GBMWizardSelfTest" # TODO make this more human readable by adding spaces
        parent.categories = ["Testing.TestCases"]
        parent.dependencies = ["GBMWizard"]
        parent.contributors = ["Andrew Beers (MGH)"] # replace with "Firstname Lastname (Org)"
        parent.helpText = """
        This module was developed as a self test to perform the operations done in GBMWizard module
        """
        ...
        slicer.selfTests['GBMWizardSelfTestTest'] = self.runTest

    def runTest(self):
        tester = GBMWizardSelfTestTest()
        tester.runTest()

#
# qGBMWizardTestWidget
#

class GBMWizardSelfTestWidget:
    ...
    def setup(self):
        ...
        # test buttons
        tests = (("GBMWizard", self.ontestGBMWizard),)
    ...
    def ontestGBMWizard(self):
        tester = GBMWizardSelfTestTest()
        tester.setUp()
        tester.testGBMWizard()

#
# GBMWizardTestLogic
#

class GBMWizardSelfTestLogic:
...
class GBMWizardSelfTestTest(unittest.TestCase):
    """
